...
public class ClanController {
	...
	@RequestMapping(value = Constants.URL_CLAN
			+ Constants.URL_GET_CLAN_MEMBERS, method = RequestMethod.GET, produces = { "application/json" })
	public @ResponseBody List<ClanMembersResponse> listarLugaresDefault(@RequestParam Integer clanId) throws ServiceException {
	...
	@RequestMapping(value = Constants.URL_CLAN
			+ "/list", method = RequestMethod.POST, produces = { "application/json" })
