...
/**
 * Clase que representa la solicitud de busqueda predeterminada.
 * Ubicacion de la persona que utiliza la app.
 * Preferencia, gustos de la persona rescatada desde FB o BD.
 * Amistad, lista de amistades de FB.
 * 
 * @author framirez
 * @since 26/09/2016
 *
